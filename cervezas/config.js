// Config de la app "Cervezas". Comparte proyecto de Supabase con el resto
// de apps de este hosting, pero todas sus tablas usan el prefijo
// "cervezas_" para no chocar con las de otras apps.
//
...
window.CERVEZAS_CONFIG = {
  ...
  tablePrefix: "cervezas_",
  personas: ["Josema", "Paco"],
};
