// Config de la app "Contactos". Comparte proyecto de Supabase con el resto
// de apps de este hosting, pero todas sus tablas usan el prefijo
// "contactos_" para no chocar con las de otras apps del mismo proyecto.
//
