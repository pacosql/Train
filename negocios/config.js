// Config de la app "Negocios". Comparte proyecto de Supabase con el resto
// de apps de este hosting, pero todas sus tablas usan el prefijo
// "negocios_" para no chocar con las de otras apps del mismo proyecto.
//
